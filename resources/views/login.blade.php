...
<body class="md:h-screen md:flex md:flex-col">
    ...
    <div class="my-16 md:my-auto mx-7 md:flex justify-evenly items-center">
        ...
        <div class="py-10 rounded-[15px] shadow-[0_4px_5px_0_rgba(70,65,167,0.25)] my-5 px-3 md:px-[30px]">
            <h1 class="font-readex font-bold text-xl text-[#4641A7] text-center">Log In</h1>
            ...
            <button type="submit" class="mt-[35px] w-full bg-[#4641A7] py-2 rounded-[10px] font-readex text-sm md:text-base text-white md:w-[363px]">Log In</button>
